...
export interface UserResponse {
    ...
    name: string;
    /**
     * @generated from protobuf field: repeated string orderIds = 3;
     */
    orderIds: string[];
}
...
class UserResponse$Type extends MessageType<UserResponse> {
    constructor() {
        super("user.UserResponse", [
            ...
            { no: 3, name: "orderIds", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string name */ 2:
                    ...
                    break;
                case /* repeated string orderIds */ 3:
    ...
    internalBinaryWrite(message: UserResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.orderIds.length; i++)
            writer.tag(3, WireType.LengthDelimited).string(message.orderIds[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
